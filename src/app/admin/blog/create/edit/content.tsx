...
export default function BlogEditPageContent() {
  ...
  // Get ID from URL - could be from [id]/edit or create/edit
  const postId = params?.id ? (params.id === 'create' || params.id === 'new' ? null : params.id) : null;
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <form onSubmit={(e) => { e.preventDefault(); handleSave(); }} className="space-y-6">
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1">Enter HTML content (h2, p, ul, li, strong, em, etc.)</p>
            </div>
